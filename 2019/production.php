...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <img src="../images/Learning_Cycle_CA.png" alt="Learning Cycle Diagram" usemap="#lcmap"/>
  </div>
</div>

<map name="lcmap">
<!--   <area shape="rect" coords="244,36,379,129" href="production.php?level=exploration" alt="Exploration"> -->
  <area shape="rect" coords="257,152,392,245" href="production.php?level=invention" alt="Invention">
  <area shape="rect" coords="116,211,251,304" href="production.php?level=application" alt="Application">
</map>
...
<div class="text-center">
  <p>
    ...
    <a href="learningcycle/Primary-Production-Learning-Cycle-Correlation-Chart.pdf" class="btn btn-primary">Learning Cycle Sequence</a>
  </p>
</div>
