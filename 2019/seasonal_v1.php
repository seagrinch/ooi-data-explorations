...
<ol class="breadcrumb">
  ...
  <li><a href="seasonal_v1.php"><?= $lesson_title ?></a></li>
...
<?php 
  ...
  if ($level=='exploration') {
    $scripts[] = "javascript/seasonal_v1_exploration.js";    
  } elseif ($level=='invention') {
    $scripts[] = "javascript/seasonal_v1_invention.js";
  } elseif ($level=='application') {
    $scripts[] = "javascript/seasonal_v1_application.js";
  }
?>  
...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="list-group">
      <a href="seasonal_v1.php?level=exploration" class="list-group-item">
        <h4 class="list-group-item-heading">Exploration</h4>
        <p class="list-group-item-text">How and why does the mixed layer depth in the ocean vary?</p>
      </a>
      <a href="seasonal_v1.php?level=invention" class="list-group-item">
      ...
      <a href="seasonal_v1.php?level=application" class="list-group-item">
