...
<map name="lcmap">
  <area shape="rect" coords="244,36,379,129" href="techtonics.php?level=exploration" alt="Exploration">
<!--   <area shape="rect" coords="257,152,392,245" href="techtonics.php?level=invention" alt="Invention"> -->
<!--   <area shape="rect" coords="116,211,251,304" href="techtonics.php?level=application" alt="Application"> -->
</map>
...
<div class="text-center">
  <p>
    ...
    <a href="learningcycle/Plate-Tectonics-and-the-Seafloor.pdf" class="btn btn-primary">Learning Cycle Sequence</a>
  </p>
</div>
