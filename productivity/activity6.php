...
<?php 
  ...
  $scripts[] = "javascript/productivity6.js";
?>  

<p class="text-right"><a href="data/productivity6.csv" class="btn btn-sm btn-primary">Download this Dataset</a></p>
...
<?php
  $json_file = file_get_contents('images_json/productivity6.json');
...
<?php if ($level=='exploration'): ?>
<p class="text-right">Finished the activity?  Please take our quick <a href="https://rutgers.qualtrics.com/SE/?SID=SV_1MGDrYEOVXMWP6B" class="btn btn-sm btn-warning">Student Survey</a></p>
<?php elseif ($level=='concept_invention'): ?>
<p class="text-right">Finished the activity?  Please take our quick <a href="https://rutgers.qualtrics.com/SE/?SID=SV_bI0Fl5RwpDJP5Ix" class="btn btn-sm btn-warning">Student Survey</a></p>
<?php elseif ($level=='application'): ?>
<p class="text-right">Finished the activity?  Please take our quick <a href="https://rutgers.qualtrics.com/SE/?SID=SV_e593KM0pjfrKLpb" class="btn btn-sm btn-warning">Student Survey</a></p>
<?php endif; ?>
...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="list-group">
      ...
      <a href="activity6.php?level=concept_invention" class="list-group-item">
