<?php 
  $page = 'workshops';
  $page_title = 'Exploring Geology in the Ocean with OOI Data';
  $base_url = '../';
...
<h2>Exploring Geology in the Ocean with OOI Data<br>
...
<h3>Presentations</h3>
<ul>
  <li>Welcome from the OOI Program (Mike Crowley)</li>
  <li>Introduction to the Learning Cycle (Catherine Halversen)</li>
  <li>Axial Seamount Overview Discussion (Deb Kelley)</li>
...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <ul>
      ...
      <li><a href="http://oceanobservatories.org/planning-history/">OOI History &amp; Context</a> - Learn more about why the OOI came to be what it is and where it is going in the future</li>
      <li><a href="http://oceanobservatories.org/data-portal/">OOI Data Portal</a> - Access other OOI collected data to explore with your students (check out the video tutorials)</li>
...
<table class="table table-striped table-condensed">
  <thead>
    <tr>
      <th>Name</th><th>Institution</th><th>Project Role</th>
    </tr>
  </thead>
  <tbody>
