/* 
  OOI Data Labs Notebook - Techtonics #2 - Toggle Earthquakes and Volcanoes
...
*/
  ...
  toggle_dots = function(depth) {
    var showEarthquakes = d3.select('#earthquakeToggle').property('checked')
    //console.log(depth,showEarthquakes)
    var dots = d3.selectAll('.mapDots')
    if (showEarthquakes) {
