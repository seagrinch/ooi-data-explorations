<?php 
  $page = 'home';
  $page_title = 'Activity Invitation';
  $base_url = '../';
  include_once('../header.php'); 
?>

<h2><small>Invitation Activity</small><br> Invitation Concept Map of Primary Productivity</h2>

<h3>Your Objective</h3>
<p>Use the OOI Concept Map Builder tool to create a concept map of <em>primary productivity</em>.</p>
