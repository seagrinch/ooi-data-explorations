...
<?php if ($level=='exploration'): ?>
<p style="text-align: right;">Finished the activity?  Please take our quick <a href="https://rutgers.qualtrics.com/SE/?SID=SV_1MGDrYEOVXMWP6B" class="btn btn-sm btn-warning">Student Survey</a></p>
<?php elseif ($level=='concept_invention'): ?>
<p style="text-align: right;">Finished the activity?  Please take our quick <a href="https://rutgers.qualtrics.com/SE/?SID=SV_bI0Fl5RwpDJP5Ix" class="btn btn-sm btn-warning">Student Survey</a></p>
<?php elseif ($level=='application'): ?>
<p style="text-align: right;">Finished the activity?  Please take our quick <a href="https://rutgers.qualtrics.com/SE/?SID=SV_e593KM0pjfrKLpb" class="btn btn-sm btn-warning">Student Survey</a></p>
<?php endif; ?>
